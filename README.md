...
> Версия 2026-08-07: генератор переработан под более живую ленту. Добавлен отдельный feed-appeal score, новые human-first форматы и приоритет реальных графиков для ключевых постов. Подробности: `HUMAN_FEED_EDITION.md`.
